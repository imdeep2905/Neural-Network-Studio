...
# optimize code
'''
from PySide2.QtWidgets import QWidget, QPushButton, QFormLayout, QLabel, QVBoxLayout, QHBoxLayout,QAbstractItemView, QGridLayout,QListWidget, QComboBox, QStackedLayout, QLineEdit
...
class NetworkController(QWidget):
    def __init__(self):
        ...
        #self.loss_stack = QStackedLayout()
        self.metrics_selector = QListWidget()
        ...
        self.metrics_selector.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        self.main_layout.addWidget(QLabel("Optimizer:"), 1, 0)
        self.main_layout.addWidget(self.optimizer_selector, 1 , 1)
        self.main_layout.addWidget(tmp,2, 0 , 1, 2)
